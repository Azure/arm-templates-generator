...
module Azure::ARM::Network
    ...
    # Model object.
    #
    class DhcpOptions < Azure::ARM::TypeBase
      ...
      #
      def validate
        fail ArgumentError, 'property dns_servers is nil' if @dns_servers.nil?
      ...
      def to_h
        hash = {}
        DhcpOptions.serialize_object(hash,self)
        hash
      end
      ...
      def initialize(parent, init)
        super(parent)
        if init.is_a? Hash
          DhcpOptions.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = DhcpOptions.new nil, init
