...
module Azure::ARM::Network
    ...
    # Model object.
    #
    class FrontendIPConfigurations < Azure::ARM::TypeBase

      # @return [String]
      attr_accessor :name

      # @return [FrontendIPConfigurationsProperties]
      ...
      def to_h
        hash = {}
        FrontendIPConfigurations.serialize_object(hash,self)
        hash
      end
      ...
      # @return [FrontendIPConfigurations] Deserialized object.
      #
      ...
      def initialize(parent, init)
        super(parent)
        if init.is_a? Hash
          FrontendIPConfigurations.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def properties(props)
          if @parent.properties.nil? and props.is_a? FrontendIPConfigurationsProperties
            @parent.properties = props
            @parent.properties.parent = @parent
            @parent.properties._rsrcpath = 'properties'
          end
          if @parent.properties.nil? and (props.is_a? Hash) and (Azure::ARM::TypeBase.matches_type props, FrontendIPConfigurationsProperties)
            @parent.properties = FrontendIPConfigurationsProperties.new(@parent, props)
            @parent.properties._rsrcpath = 'properties'
          end
          @parent.properties
        end
        ...
        #        Id
        def subnet(props)
          @parent.properties = (FrontendIPConfigurationsProperties.new @parent, nil) if @parent.properties.nil?
        ...
        def public_ipaddress(props)
          ...
          if @parent.properties.public_ipaddress.nil? and (props.respond_to? :to_rsrcid)
            ...
            if props.is_a? Azure::ARM::TypeBase and !props.containing_resource.nil?
              @parent.containing_resource.add_dependency props.containing_resource unless @parent.containing_resource.nil?
            end
          end
          @parent.properties.public_ipaddress
        end
        def create(init=nil,&block)
          @parent = FrontendIPConfigurations.new nil, init
