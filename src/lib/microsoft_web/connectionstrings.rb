...
module Azure::ARM::Web
    ...
    # Model object.
    #
    class Connectionstrings < Azure::ARM::TypeBase

      # @return [connectionstrings_name] Possible values include:
      # 'connectionstrings'
      attr_accessor :name
      ...
      def to_h
        hash = {}
        Connectionstrings.serialize_object(hash,self)
        hash
      end
      ...
      # @return [Connectionstrings] Deserialized object.
      #
      ...
      def initialize(parent, init)
        super(parent)
        @name = 'connectionstrings' if @name.nil?
        if init.is_a? Hash
          Connectionstrings.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = Connectionstrings.new nil, init
