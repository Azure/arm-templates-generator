...
module Azure::ARM::Web
    ...
    #
    class Extension < Azure::ARM::ResourceBase
      ...
      def to_h
        self.validate
        hash = {}
        Extension.serialize_object(hash,self)
        hash
      end
      ...
      # @return [Extension] Deserialized object.
      #
      ...
      def initialize(parent, init)
        ...
        if init.is_a? Hash
          Extension.deserialize_object self, init.clone
        end 
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def properties(props)
          if @parent.properties.nil? and props.is_a? ExtensionsProperties
            @parent.properties = props
            @parent.properties.parent = @parent
            @parent.properties._rsrcpath = 'properties'
          end
          if @parent.properties.nil? and (props.is_a? Hash) and (Azure::ARM::TypeBase.matches_type props, ExtensionsProperties)
            @parent.properties = ExtensionsProperties.new(@parent, props)
            @parent.properties._rsrcpath = 'properties'
          end
          @parent.properties
        end
        ...
        def package_uri(props)
          @parent.properties = (ExtensionsProperties.new @parent, nil) if @parent.properties.nil?
        ...
        def create(init=nil,&block)
          @parent = Extension.new @template,init
