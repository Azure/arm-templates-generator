...
module Azure::ARM::Sql
    #
    # Microsoft.Sql/databasesChild
    #
    class DatabasesChild < Azure::ARM::ResourceBase
      ...
      def to_h
        self.validate
        hash = {}
        DatabasesChild.serialize_object(hash,self)
        hash
      end
      ...
      # @return [DatabasesChild] Deserialized object.
      #
      ...
      def initialize(parent, init)
        ...
        if init.is_a? Hash
          DatabasesChild.deserialize_object self, init.clone
        end 
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = DatabasesChild.new @template,init
