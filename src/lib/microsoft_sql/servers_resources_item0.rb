...
module Azure::ARM::Sql
    ...
    # Model object.
    #
    class ServersResourcesItem0 < Azure::ARM::ResourceBase
      ...
      def to_h
        self.validate
        hash = {}
        ServersResourcesItem0.serialize_object(hash,self)
        hash
      end
      ...
      # @return [ServersResourcesItem0] Deserialized object.
      #
      ...
      def initialize(parent, init)
        super(parent, init)
        self.type = 'databases' if self.type.nil?
        self.api_version = '2014-04-01-preview' if self.api_version.nil?
        if init.is_a? Hash
          ServersResourcesItem0.deserialize_object self, init.clone
        end 
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = ServersResourcesItem0.new @template,init
