...
module Azure::ARM::NotificationHubs
    ...
    # Model object.
    #
    class NotificationHubsPropertiesAuthorizationRules0 < Azure::ARM::TypeBase
      ...
      # @return [notificationHubs_properties_authorizationRules_0_rights]
      # Microsoft.NotificationHubs/namespaces/notificationHubs: Authorization
      ...
      def to_h
        hash = {}
        NotificationHubsPropertiesAuthorizationRules0.serialize_object(hash,self)
        hash
      end
      ...
      # @return [NotificationHubsPropertiesAuthorizationRules0] Deserialized
      # object.
      #
      ...
      def initialize(parent, init)
        ...
        if init.is_a? Hash
          NotificationHubsPropertiesAuthorizationRules0.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = NotificationHubsPropertiesAuthorizationRules0.new nil, init
