...
module Azure::ARM::NotificationHubs
    ...
    # Model object.
    #
    class NotificationHubsPropertiesApnsCredential0 < Azure::ARM::TypeBase
      ...
      def to_h
        hash = {}
        NotificationHubsPropertiesApnsCredential0.serialize_object(hash,self)
        hash
      end
      ...
      # @return [NotificationHubsPropertiesApnsCredential0] Deserialized
      # object.
      #
      ...
      def initialize(parent, init)
        super(parent)
        if init.is_a? Hash
          NotificationHubsPropertiesApnsCredential0.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = NotificationHubsPropertiesApnsCredential0.new nil, init
