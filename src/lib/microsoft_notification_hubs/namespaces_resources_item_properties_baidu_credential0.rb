...
module Azure::ARM::NotificationHubs
    ...
    # Model object.
    #
    class NamespacesResourcesItemPropertiesBaiduCredential0 < Azure::ARM::TypeBase
      ...
      def to_h
        hash = {}
        NamespacesResourcesItemPropertiesBaiduCredential0.serialize_object(hash,self)
        hash
      end
      ...
      # @return [NamespacesResourcesItemPropertiesBaiduCredential0]
      # Deserialized object.
      #
      ...
      def initialize(parent, init)
        super(parent)
        if init.is_a? Hash
          NamespacesResourcesItemPropertiesBaiduCredential0.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = NamespacesResourcesItemPropertiesBaiduCredential0.new nil, init
