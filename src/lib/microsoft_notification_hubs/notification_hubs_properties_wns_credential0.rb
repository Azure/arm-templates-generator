...
module Azure::ARM::NotificationHubs
    ...
    # Model object.
    #
    class NotificationHubsPropertiesWnsCredential0 < Azure::ARM::TypeBase
      ...
      def to_h
        hash = {}
        NotificationHubsPropertiesWnsCredential0.serialize_object(hash,self)
        hash
      end
      ...
      # @return [NotificationHubsPropertiesWnsCredential0] Deserialized object.
      #
      ...
      def initialize(parent, init)
        super(parent)
        if init.is_a? Hash
          NotificationHubsPropertiesWnsCredential0.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = NotificationHubsPropertiesWnsCredential0.new nil, init
