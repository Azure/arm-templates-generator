...
module Azure::ARM::Compute
    ...
    # Model object.
    #
    class OsProfile < Azure::ARM::TypeBase
      ...
      #
      def validate
        fail ArgumentError, 'property computer_name is nil' if @computer_name.nil?
      ...
      def to_h
        hash = {}
        OsProfile.serialize_object(hash,self)
        hash
      end

      def self.ds_properties
        result = Array.new 
        result.push :computer_name
      ...
      def self.deserialize_object(output_object, object)
        ...
        if object.key?(:computer_name)
          conf.computer_name object[:computer_name]
          object.delete :computer_name
        end
      ...
      def initialize(parent, init)
        super(parent)
        if init.is_a? Hash
          OsProfile.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        # @param computer_name
        #        String
        def computer_name(props)
          if props.is_a? String or props.is_a? Azure::ARM::Expression
            @parent.computer_name = props
            return
          end
          @parent.computer_name
        end
