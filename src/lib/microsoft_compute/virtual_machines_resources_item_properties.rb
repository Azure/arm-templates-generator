...
module Azure::ARM::Compute
    ...
    # Model object.
    #
    class VirtualMachinesResourcesItemProperties < Azure::ARM::TypeBase
      ...
      def to_h
        hash = {}
        VirtualMachinesResourcesItemProperties.serialize_object(hash,self)
        hash
      end
      ...
      # @return [VirtualMachinesResourcesItemProperties] Deserialized object.
      #
      ...
      def initialize(parent, init)
        super(parent)
        if init.is_a? Hash
          VirtualMachinesResourcesItemProperties.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = VirtualMachinesResourcesItemProperties.new nil, init
