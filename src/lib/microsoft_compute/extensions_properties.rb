...
module Azure::ARM::Compute
    ...
    # Model object.
    #
    class ExtensionsProperties < Azure::ARM::TypeBase

      # @return [String] Microsoft.Compute/extensions - Publisher
      attr_accessor :publisher

      # @return [String] Microsoft.Compute/extensions - Type
      attr_accessor :type

      # @return [String] Microsoft.Compute/extensions - Type handler version
      attr_accessor :type_handler_version

      # @return Microsoft.Compute/extensions - Settings
      ...
      def to_h
        hash = {}
        ExtensionsProperties.serialize_object(hash,self)
        hash
      end
      ...
      # @return [ExtensionsProperties] Deserialized object.
      #
      ...
      def initialize(parent, init)
        super(parent)
        if init.is_a? Hash
          ExtensionsProperties.deserialize_object self, init.clone
        end
      end
      ...
      class Configurator < Azure::ARM::ResourceConfigurator
        ...
        def create(init=nil,&block)
          @parent = ExtensionsProperties.new nil, init
